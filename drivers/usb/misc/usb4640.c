// mz8023yt@163.com 20180321 begin >>> [9/11] add usb net driver
/*
...
static int usb4640_probe(struct usb4640 *hub)
{
	...
	if (gpio_is_valid(hub->gpio_reset)) {
		err = devm_gpio_request_one(dev, hub->gpio_reset, GPIOF_OUT_INIT_LOW, "usb4640 reset");
		if (err) {
	...
	dev_info(dev, "%s: probed in %s mode\n", __func__, (hub->mode == USB4640_MODE_HUB) ? "hub" : "standby");
	return 0;
}
...
MODULE_LICENSE("GPL");
// mz8023yt@163.com 20180321 end   <<< [9/11] add usb net driver