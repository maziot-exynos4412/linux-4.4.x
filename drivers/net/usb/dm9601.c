...
// mz8023yt@163.com 20180321 begin >>> [5/11] add usb net driver
...
// mz8023yt@163.com 20180321 end   <<< [5/11] add usb net driver
...
static int dm9601_bind(struct usbnet *dev, struct usb_interface *intf)
{
	 ...
	 */
// mz8023yt@163.com 20180321 begin >>> [6/11] add usb net driver
	if (is_valid_ether_addr(param_addr)) {
		/* write MAC to dm9621 */
		memcpy(dev->net->dev_addr, param_addr, ETH_ALEN);
		__dm9601_set_mac_address(dev);
	} else if (is_valid_ether_addr(mac))
// mz8023yt@163.com 20180321 end   <<< [6/11] add usb net driver
